    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.search, size: 27.sp),
          ),
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.more_vert, size: 27.sp),
          ),
        ],
      ),
      body: Column(
            ...
            child: Row(
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(
                    context,
                  ).textTheme.headlineMedium?.copyWith(fontSize: 16.sp,color:
                  provider.themeMode==ThemeMode.dark ? MyTheme.whiteColor:MyTheme.blackColor),
                ),
              ],
            ),
          ),
